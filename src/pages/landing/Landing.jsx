  ...
  return (
    ...
    bg-clip-text text-transparent"
            ...
            <div className="hidden  md:flex gap-8 text-xs font-bold tracking-widest uppercase">
              <a
                href="#features"
                className="hover:opacity-60 hover:text-[#d1ec44]  transition-opacity"
              >
                Control Center
              </a>
              <a
            ...
            >
              ...
              >
                ...
                <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-xl font-medium">
                  “Job Finding, Worker/Bulk Hiring, Job Management,
                  photo-verified work, and automated pay — end-to-end workforce
                  control.”
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4 max-w-lg">
                {[
                  ...
                  >
                    ...
                    <div
                      className={`text-3xl font-black transition-colors ${card.color} group-hover:text-[#38b6ff]`}
                    >
                      {card.value}
                    </div>
          ...
          <div className="max-w-4xl mx-auto px-6 md:px-12 text-center relative z-10">
            <div className="mb-12">
              ...
              <p className="text-lg text-white/60 max-w-2xl mx-auto">
                500+ companies. 12,000+ workers. Zero fraud. 100% payroll
                accuracy. Built for India's blue-collar reality.
              </p>
            </div>
          ...
          <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
            <div className="md:col-span-4">
              ...
              <p className="text-white/60 leading-relaxed mb-6 max-w-xs">
                Blue-collar workforce control platform. Photo-verified
                attendance. Automated payroll. Complete transparency.
              </p>
